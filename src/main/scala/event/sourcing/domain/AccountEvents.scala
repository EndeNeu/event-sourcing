...
object AccountEvents {
  ...
  case class AccountDebitFromTransferEvent(entityId: EntityId, transferId: EntityId, debit: Long) extends AccountEventLike

  case class AccountCreditEvent(entityId: EntityId, credit: Long) extends AccountEventLike
  case class AccountCreditFromTransferEvent(entityId: EntityId, transferId: EntityId, credit: Long) extends AccountEventLike
